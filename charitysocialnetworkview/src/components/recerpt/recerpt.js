...
const rows = [
    createRow('Gây quỹ ủng hộ trẻ em nghèo vượt khó năm 2021', 1, 1.15),
];
                                    ...
                                    <TableCell>
                                        <div style={{ display: "flex" }}>
                                            <div style={{ width: "20%" }}>
                                                <img
                                                    style={{ width: "100%" }}
                                                    src="https://lh3.googleusercontent.com/proxy/Id34oT7Hbbqx-q1g7sE25qaqohgrOscf_wy_bhvzY3uiIEJIucRolx_kuTJ0cSSoLClugkIoBsVwZ6iG1b1_n4-dDAgcTKjSuamO1henTXWtGjmvyyj9PoXF39aXaRSXCUGXKyjVnQxwno0YOQ"
                                                />
                                            </div>
